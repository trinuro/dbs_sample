...
const Navbar = () =>{
    return (
        <nav className='bg-dayak-motif-light relative -z-10'>
            <div className='absolute w-full h-full bg-white/95 -z-10'></div>
            <div className='px-8 lg:pt-3 py-5 w-max lg:w-[80%]  align-middle max-container padding-container flex-col '>
