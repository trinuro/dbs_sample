...
const Hero = () => {
    return(
        <section id='Home' className='relative flex-nowrap bg-cover bg-no-repeat bg-dun-and-bcs bg-center -z-20'>
            <div className=' max-container padding-container pt-5 lg:pt-20 bg-white/50'>
                <div className='text-center lg:bold-64 flex flex-col whitespace-nowrap gap-0'>
                    ...
                    <p id='SARAWAK_TEXT' className='font-horta text-[100px] p-0 m-0 leading-tight text-yellow-dbsYellow lg:text-[300px] drop-shadow-xl [text-shadow:_#ff3131_2px_5px_3px] lg:[text-shadow:_#ff3131_4px_10px_3px]'>SARAWAK</p>
